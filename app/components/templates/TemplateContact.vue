    ...
    <section style="background-color: var(--anthracite); padding-top: 160px; padding-bottom: 80px;">
      <div class="container-brand" style="text-align: center;">
        ...
        <p class="reveal" style="font-size: 18px; color: #BDBDBD; max-width: 640px; margin: 0 auto; line-height: 1.7;">
          Discutons de votre projet. Notre équipe est à votre écoute pour transformer votre vision en réalité architecturale.
        </p>
      </div>
    </section>
      ...
      <div class="container-brand">
        <div class="contact-grid">
          <div class="reveal-left">
            <h2 class="font-heading" style="font-size: 28px; font-weight: 600; color: var(--anthracite); margin-bottom: 32px;">Nos Coordonnées</h2>
